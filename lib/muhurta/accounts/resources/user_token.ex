defmodule Muhurta.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Muhurta.Accounts.UserToken
  ...
  @primary_key {:user_token_id, :binary_id, autogenerate: true}
  @foreign_key_type :binary_id
  schema "users_tokens" do
    field :token, :binary
    field :context, :string
    field :sent_to, :string
    belongs_to :user, Muhurta.Accounts.User, references: :user_id
